<!-- QueryToSerialize: TABLE date as "Date", style as "style", "![anyName|300](" + image + ")" AS "Cover" FROM "art" WHERE artist = "Andre Masson" SORT date -->
<!-- SerializedQuery: TABLE date as "Date", style as "style", "![anyName|300](" + image + ")" AS "Cover" FROM "art" WHERE artist = "Andre Masson" SORT date -->
...
| [[Ibdes in Aragon]]                           | January 09, 1935 | <ul><li>surrealism</li></ul>                | ![anyName\|300](https://i.imgur.com/6LadggS.jpeg) |
